#!/usr/bin/env bash
# Launch vLLM for Baichuan-M2-32B (matches configs/models/baichuan_m2_32b_vllm.yaml).
...
MODEL_ID="${VLLM_MODEL_ID:-baichuan-inc/Baichuan-M2-32B}"
SERVED_NAME="${VLLM_SERVED_NAME:-baichuan-m2-32b}"
