#!/usr/bin/env bash
# Launch vLLM for Gemma-4-31B-it (matches configs/models/gemma4_31b_it_vllm.yaml).
...
MODEL_ID="${VLLM_MODEL_ID:-google/gemma-4-31B-it}"
SERVED_NAME="${VLLM_SERVED_NAME:-gemma-4-31b-it}"
